        ...
        while True:
            ...
            for record in records:
                ...
                if record.error():
                    ...
                    #連接mysql資料庫
                    try:
                        db_data = 'mysql+pymysql://root:123456@localhost:3306/kafka_test?charset=utf8mb4'
                    ...
                    try:
                        db_data = pymysql.connect("localhost","root","123456","kafka_test" )
                        cursor = db_data.cursor()
                        
                        sql="INSERT INTO test(time, num, text) VALUES ('%s', '%d',  '%s')" %(msgValue.split(',')[0],int(msgValue.split(',')[1]),msgValue.split(',')[2]);
